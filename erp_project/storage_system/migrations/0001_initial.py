# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2019-12-10 09:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('modified_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_category', to='storage_system.Category', verbose_name='分类')),
            ],
            options={
                'verbose_name': '产品',
        ...
        migrations.AddField(
            model_name='sold',
            name='status',
            field=models.ForeignKey(default=4, on_delete=django.db.models.deletion.CASCADE, related_name='sold_status', to='storage_system.Status', verbose_name='商品状态'),
        ),
        migrations.AddField(
            model_name='sold',
            name='tag',
